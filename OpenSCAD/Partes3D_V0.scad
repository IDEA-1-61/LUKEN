...
module ApoyoMotorZ(){
    ...
    translate([lonNEMA/2,espesor,lonX_c-espesor])
    rotate([0,90,90])
    difference(){
              ...
              translate([(lonX_c/2)-espesor,0,-lonZ_c/2])
                difference(){ 
                   ...
                   //recorte 1 cilindro
                   translate([0,(lonY_c/2)-0.5,lonZ_c/2])
                   rotate([90,0,90])
